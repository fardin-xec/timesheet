...
const ForgotPasswordForm = () => {
  ...
  const handleOtpSubmit = async (e) => {
    ...
    try {
      ...
      setToast({
        open: true,
        message: err.response?.data?.message || 'Error verifying OTP. Please try again.',
        severity: "error",
      });
    } finally {
      setLoading(false);
  ...
  const handlePasswordSubmit = async (e) => {
    ...
    try {
      ...
      setToast({
        open: true,
        message: err.response?.data?.message || 'Error resetting password. Please try again.',
        severity: "error",
      });
    } finally {
      setLoading(false);
  ...
  if (step === 'success') {
    return (
      <div className="auth-form success-container">
        ...
        <p className="success-message">Your password has been reset successfully. You can now log in with your new password.</p>
